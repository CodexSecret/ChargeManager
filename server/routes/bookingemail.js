...
router.post("/:id", validateToken, async (req, res) => {
    const source = fs.readFileSync("./public/views/bookingemail.hbs", "utf8");
    ...
    try {
        ...
        const htmlContent = template({
            title: "Booking Rental Confirmation",
            heading: "Charge Booking Rental Confirmation",
        ...
        const message = {
            ...
            subject: `Booking Details - ${booking.carModelNew}`,
            html: htmlContent,
        };
